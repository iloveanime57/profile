...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Kiet Luuy";
            $("#favicon").attr("href", "assets/images/favicon.ico");
        }
        else {
            document.title = "Portfolio | Kiet Luu";
            $("#favicon").attr("href", "assets/images/favicon.ico");
        }
    });
...
var typed = new Typed(".typing-text", {
    strings: ['a Gamer', 'a Dreamer', 'a Student'],
    loop: true,
    typeSpeed: 90,
    backSpeed: 100,
    backDelay: 500,
...
srtop.reveal('.experience .timeline .container', { interval: 0 });
